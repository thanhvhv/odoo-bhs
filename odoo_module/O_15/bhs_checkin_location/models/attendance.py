...
class BHHrAttendance(models.Model):
    ...
    attendance_location = fields.Many2one('hr.attendance.location', 'Check in location', default=lambda self: self.env.ref('bhs_checkin_location.attendance_location_company', raise_if_not_found=False))
